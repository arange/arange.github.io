var spliter = {
	...
	recordEl : '<i class="record"><input class="sharer" placeholder="Names of all people" /> share the bill for $<input class="aom" placeholder="Amount" />, <input class="payer" placeholder="Payer" /> paid for it.</i>',
	recordNum : 0,
